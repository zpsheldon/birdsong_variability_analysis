...
timing_strct.wavdir = matchstrct.wavdir;
...
distrct.wavdir = matchstrct.wavdir;
...
matchstrct = get(handles.load_match_data,'UserData');
seq_strct.wavdir = matchstrct.wavdir;
...
matchstrct = get(handles.load_match_data,'UserData');
trans_strct.wavdir = matchstrct.wavdir;
...
matchstrct = get(handles.load_match_data,'UserData');
spec_strct.wavdir = matchstrct.wavdir;
